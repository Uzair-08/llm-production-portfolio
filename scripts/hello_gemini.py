...
from llmkit import LLMClient

client = LLMClient()
resp = client.complete("In one sentence: what is the difference between a unit test and an integration test?")
print(resp.text)
print(f"model={resp.model} cost=${resp.cost_usd:.6f} latency={resp.latency_ms:.0f}ms")